...
export default class AtCalendar extends React.Component {
  ...
  render() {
    ...
    const { validDates, marks, format, minDate, maxDate, isSwiper, className, hideArrow, isVertical, monthFormat, selectedDates, startFromMonday,singleMonth } = this.props;
