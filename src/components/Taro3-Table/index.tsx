...
const Table = (props: Props): JSX.Element => {
    ...
    const [expansion, setExpansion] = useState<boolean>(true); // 是否展开
        ...
        return (
            <View
                ...
                style={{
                    ...
                    ...column.titleStyle,
                    ...titleStyle,
                    justifyContent: JC_TA_MAP[column.align || 'center']
                }}
            ...
            >
                ...
                {
                    column.sort && (
                        <View className="taro3table-thead-sort">
                            <View className={classnames({
                                'taro3table-thead-sortbtn': true,
                                'taro3table-thead-sortbtn--ascend': true,
                                'active': (column.sortOrder === 'ascend')
                            })}
                            />
                            <View className={classnames({
                                'taro3table-thead-sortbtn': true,
                                'taro3table-thead-sortbtn--descend': true,
                        ...
                        return (
                            <View
                                ...
                                style={{
                                    ...
                                    justifyContent: JC_TA_MAP[columnItem.align || 'center'],
    ...
    const DataLoading = () => {
        return (
            <View className="taro3table-loading">
                {/* <Text>加载中</Text>*/}
                <Loading color="#0076FF" />
            </View>
        );
    };
    // 暂无数据
    const Empty = () => {
        return (
            <View className="taro3table-nothing">
                <Text>Empty</Text>
            </View>
        );
    };
    ...
    return (
        ...
        >
            ...
            >
                ...
                <View className="taro3table-tbody">
                    {
